...
class HeterogenousSparseDataset(Dataset):
    ...
    def __getitem__(self, item) -> List[Tuple[Tensor, ...]]:
        ...
        targets_dense_x = torch.sparse_coo_tensor(
            coordinates_x,
            targets_x
        ).to_dense()
        
        object_targets_dense_x = torch.sparse_coo_tensor(
            coordinates_x,
            object_targets_x
        ).to_dense()
        ...
        targets_dense_y = torch.sparse_coo_tensor(
            coordinates_y,
            targets_y
        ).to_dense()
        
        object_targets_dense_y = torch.sparse_coo_tensor(
            coordinates_y,
            object_targets_y
        ).to_dense()
        ...
        return hits_index, (
            features_dense_x,
            targets_dense_x,
            object_targets_dense_x
        ), (
            features_dense_y,
            targets_dense_y,
            object_targets_dense_y
        )